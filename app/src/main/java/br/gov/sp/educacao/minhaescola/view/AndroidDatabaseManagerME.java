...
public class AndroidDatabaseManagerME extends Activity implements OnItemClickListener {
...
// all global variables
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //in the below line Change the text 'yourCustomSqlHelper' with your custom sqlitehelper class name
        dbm = new DBCore(AndroidDatabaseManagerME.this);

        mainscrollview = new ScrollView(AndroidDatabaseManagerME.this);
        ...
        mainLayout = new LinearLayout(AndroidDatabaseManagerME.this);
        ...
        final LinearLayout firstrow = new LinearLayout(AndroidDatabaseManagerME.this);
        firstrow.setPadding(0,10,0,20);
        LinearLayout.LayoutParams firstrowlp = new LinearLayout.LayoutParams(0, 150);
        firstrowlp.weight = 1;

        TextView maintext = new TextView(AndroidDatabaseManagerME.this);
        maintext.setText("Select Table");
        maintext.setTextSize(22);
        maintext.setLayoutParams(firstrowlp);
        select_table=new Spinner(AndroidDatabaseManagerME.this);
        ...
        TextView secondrowtext = new TextView(AndroidDatabaseManagerME.this);
        secondrowtext.setText("No. Of Records : ");
        secondrowtext.setTextSize(20);
        secondrowtext.setLayoutParams(secondrowlp);
        tv =new TextView(AndroidDatabaseManagerME.this);
        tv.setTextSize(20);
        ...
        final Button submitQuery = new Button(AndroidDatabaseManagerME.this);
        ...
        final TextView help = new TextView(AndroidDatabaseManagerME.this);
        ...
        final Spinner spinnertable =new Spinner(AndroidDatabaseManagerME.this);
        ...
        final LinearLayout thirdrow = new LinearLayout(AndroidDatabaseManagerME.this);
        previous = new Button(AndroidDatabaseManagerME.this);
        previous.setText("Previous");

        previous.setBackgroundColor(Color.parseColor("#BAE7F6"));
        previous.setLayoutParams(secondrowlp);
        next = new Button(AndroidDatabaseManagerME.this);
        next.setText("Next");
        ...
        tvmessage =new TextView(AndroidDatabaseManagerME.this);
        ...
        final Button customQuery = new Button(AndroidDatabaseManagerME.this);
        ...
        ArrayAdapter<String> tablenamesadapter = new ArrayAdapter<String>(AndroidDatabaseManagerME.this,
        ...
        select_table.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent,
                ...
                if(pos!=0){
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(AndroidDatabaseManagerME.this,
                    ...
                    if(c2!=null)
                    {
                        ...
                        spinnertable.setOnItemSelectedListener((new AdapterView.OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            if(!isFinishing()){
                                                ...
                                                new AlertDialog.Builder(AndroidDatabaseManagerME.this)
                                ...
                                if(spinnertable.getSelectedItem().toString().equals("Add row to this table"))
                                {
                                    ...
                                    final ScrollView addrowsv =new ScrollView(AndroidDatabaseManagerME.this);
                                    ...
                                    final RelativeLayout addnewlayout = new RelativeLayout(AndroidDatabaseManagerME.this);
                                    ...
                                    for(int i=0;i<addnewrownames.size();i++)
                                    {
                                        ...
                                        et.setId(k);
                                        final LinearLayout ll = new LinearLayout(AndroidDatabaseManagerME.this);
                        ...
                        {
                            LinearLayout cell = new LinearLayout(AndroidDatabaseManagerME.this);
    ...
    public void updateDeletePopup()
    {
        ...
        final RelativeLayout lp = new RelativeLayout(AndroidDatabaseManagerME.this);
        lp.setBackgroundColor(Color.WHITE);
        RelativeLayout.LayoutParams lay = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        lay.addRule(RelativeLayout.ALIGN_PARENT_TOP);

        final ScrollView updaterowsv =new ScrollView(AndroidDatabaseManagerME.this);
        LinearLayout lcrud = new LinearLayout(AndroidDatabaseManagerME.this);
        ...
        ArrayAdapter<String> crudadapter = new ArrayAdapter<String>(AndroidDatabaseManagerME.this,
